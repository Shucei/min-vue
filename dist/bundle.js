...
var CompileUtil = {
  ...
  */
  text: function text(node, expression, vm) {
    var _this = this;
    ...
    var updateText = function updateText() {
      ...
      if (reg.test(expression)) {
        value = expression.replace(reg, function (matched, placeholder) {
          // 从视图模型中获取属性的值
          var propertyValue = _this.getVMValue(vm, placeholder);
          // 使用解析后的属性值更新节点的文本内容
  ...
  model: function model(node, expression, vm) {
    // 处理模型指令（例如 v-model="someProperty"）
    // 从视图模型中获取属性的值
    var propertyValue = this.getVMValue(vm, expression);

    // 使用解析后的属性值更新节点的文本内容
    node.value = propertyValue;
  },
  bind: function bind(node, expression, vm, eventName) {
  ...
  on: function on(node, expression, vm, eventName) {
  ...
  // 辅助方法：从视图模型中获取属性的值
  getVMValue: function getVMValue(vm, propertyName) {
    var value = vm;
    propertyName.split('.').forEach(function (key) {
      value = vm[key];
    });
    return value;
  }
...
var Watcher = /*#__PURE__*/function () {
  ...
  _createClass(Watcher, [{
    ...
    value: function get() {
      Dep.target = this;
      var value = CompileUtil.getVMValue(this.vm, this.expression);
      Dep.target = null;
      return value;
    }
  }, {
    ...
    value: function update() {
      var newValue = CompileUtil.getVMValue(this.vm, this.expression);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CompileUtil);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   newArrayproto: () => (/* binding */ newArrayproto)
/* harmony export */ });
// 重写数组中的部分方法
...
var Observe = /*#__PURE__*/function () {
  function Observe(data) {
    ...
    if (Array.isArray(data)) {
      // 如果是数组需要重写数组的方法
      data.__proto__ = _array__WEBPACK_IMPORTED_MODULE_0__.newArrayproto;
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _compile_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./compile/index.js */ "./src/compile/index.js");
/* harmony import */ var _observe_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./observe/index.js */ "./src/observe/index.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
  ...
  _createClass(Vue, [{
    ...
    value: function compile(node) {
      ...
      childNodes.forEach(function (child) {
        if (child.nodeType === 1) {
          // 元素节点
          var attributes = child.attributes; // 获取元素节点的属性
          ...
          _toConsumableArray(attributes).forEach(function (attr) {
            ...
            if (name.startsWith('v-')) {
              ...
              _compile_index_js__WEBPACK_IMPORTED_MODULE_0__["default"][directiveName](child, value, _this, eventName);
            }
            if (name.startsWith('@')) {
              var _name$split3 = name.split('@'),
                _name$split4 = _slicedToArray(_name$split3, 2),
                _eventName = _name$split4[1];
              _compile_index_js__WEBPACK_IMPORTED_MODULE_0__["default"].on(child, value, _this, _eventName);
            }
          });
          ...
          // 文本节点
          _compile_index_js__WEBPACK_IMPORTED_MODULE_0__["default"].text(child, child.textContent, _this);
        }
      });
    }
    ...
    value: function initState(data) {
      if (data) {
        ...
        (0,_observe_index_js__WEBPACK_IMPORTED_MODULE_1__.observe)(data);
    ...
    key: "proxy",
    value: function proxy(vm, target, key) {
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("6b4815b5785c4dfd5740")
/******/ 	})();
/******/ 	
